...
class RenderHelper:
    ...
    def process_inputs(self, current_date, current_weather, hourly_forecast, daily_forecast, event_list, num_cal_days, topic, path_to_server_image):
        ...
        htmlFile.write(dashboard_template.format(
            ...
            current_weather_text="Current weather",
            current_weather_id=1,
            current_weather_temp=2,
            today_weather_id=3,
            tomorrow_weather_id=4,
            dayafter_weather_id=5,
            today_weather_pop=6,
            tomorrow_weather_pop=7,
            dayafter_weather_pop=8,
            today_weather_min=9,
            tomorrow_weather_min=10,
            dayafter_weather_min=11,
            today_weather_max=12,
            tomorrow_weather_max=13,
            dayafter_weather_max=14,
