...
def setup(
    ...
    """
    Command-line interface for an app which creates & serves an image to be polled by dashboard device using wget or similar.
    
    It requires a config.toml file. If not specified with --config, it will look for one in the directory from which this script is being run.
    """
